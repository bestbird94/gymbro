...
// ── Hungarian Map ─────────────────────────────────────────────────────────────
// Pontos SVG path-ok Magyarország megyéihez (viewBox: 0 0 800 500)
const HUNGARY_PATHS = {
  "Győr-Moson-Sopron": "M 28,82 L 58,68 L 95,62 L 138,65 L 168,72 L 192,80 L 210,95 L 215,112 L 198,125 L 175,130 L 148,128 L 118,132 L 90,128 L 62,118 L 38,105 Z",
  "Komárom-Esztergom": "M 192,80 L 230,75 L 265,78 L 285,88 L 295,105 L 280,118 L 255,122 L 230,118 L 210,112 L 198,125 L 215,112 Z",
  "Vas": "M 28,130 L 62,118 L 90,128 L 118,132 L 125,155 L 115,178 L 98,195 L 72,205 L 42,198 L 22,178 L 18,152 Z",
  "Veszprém": "M 118,132 L 148,128 L 175,130 L 198,125 L 210,112 L 230,118 L 235,138 L 228,162 L 210,178 L 185,188 L 158,182 L 132,168 L 115,155 Z",
  "Zala": "M 22,178 L 42,198 L 72,205 L 98,195 L 115,178 L 125,200 L 118,228 L 98,245 L 72,250 L 45,240 L 22,220 L 15,198 Z",
  "Somogy": "M 98,195 L 125,200 L 158,182 L 185,188 L 210,195 L 228,215 L 232,242 L 218,265 L 192,272 L 158,268 L 128,258 L 102,242 L 85,222 Z",
  "Fejér": "M 230,118 L 265,112 L 295,118 L 315,132 L 318,158 L 305,178 L 282,188 L 255,185 L 235,170 L 228,148 Z",
  "Budapest": "M 310,118 L 332,112 L 348,118 L 350,132 L 338,140 L 320,138 L 308,130 Z",
  "Pest": "M 265,78 L 310,72 L 355,75 L 390,82 L 410,98 L 415,122 L 405,142 L 388,158 L 362,168 L 338,165 L 318,158 L 315,132 L 295,118 L 280,105 L 285,88 Z",
  "Tolna": "M 282,188 L 305,178 L 338,165 L 362,168 L 370,192 L 360,218 L 338,232 L 312,235 L 285,222 L 270,205 Z",
  "Baranya": "M 270,205 L 285,222 L 312,235 L 338,238 L 348,258 L 338,278 L 308,285 L 275,282 L 250,268 L 242,248 L 252,228 Z",
  "Bács-Kiskun": "M 362,168 L 405,162 L 438,168 L 458,182 L 462,210 L 448,238 L 422,252 L 392,255 L 365,248 L 348,228 L 350,205 L 360,188 Z",
  "Nógrád": "M 355,75 L 395,68 L 425,72 L 440,85 L 438,100 L 418,112 L 390,115 L 362,110 L 348,98 Z",
  "Heves": "M 390,82 L 430,78 L 462,82 L 480,98 L 478,118 L 460,132 L 438,138 L 415,132 L 405,115 L 418,112 L 438,100 L 425,88 Z",
  "Jász-Nagykun-Szolnok": "M 405,142 L 438,138 L 465,142 L 492,150 L 498,175 L 488,200 L 468,215 L 442,218 L 415,210 L 405,188 L 400,165 Z",
  "Borsod-Abaúj-Zemplén": "M 425,58 L 478,48 L 530,52 L 565,62 L 578,80 L 570,100 L 545,112 L 512,118 L 482,112 L 462,98 L 462,82 L 430,78 Z",
  "Szabolcs-Szatmár-Bereg": "M 530,52 L 588,45 L 635,48 L 658,62 L 655,90 L 635,108 L 598,115 L 565,112 L 545,98 L 545,112 L 570,100 L 565,62 Z",
  "Hajdú-Bihar": "M 512,118 L 545,112 L 598,115 L 620,128 L 622,155 L 610,178 L 582,192 L 552,195 L 525,182 L 505,162 L 498,138 Z",
  "Békés": "M 488,200 L 512,192 L 545,195 L 575,202 L 598,218 L 598,242 L 578,258 L 548,262 L 518,252 L 495,235 L 485,215 Z",
  "Csongrád-Csanád": "M 468,215 L 495,215 L 518,225 L 542,232 L 558,250 L 548,272 L 522,280 L 492,278 L 468,262 L 455,242 L 455,222 Z",
};

const MEGYE_COLORS = [
  "#e8a87c","#7ec8a0","#a8c8e8","#e8c87c","#c8a8e8",
  "#a8e8c8","#e8a8c8","#c8e8a8","#a8b8e8","#e8b8a8",
  "#b8e8c8","#d8a8b8","#a8d8b8","#c8b8a8","#b8c8d8",
  "#d8c8a8","#a8c8d8","#c8d8a8","#d8b8c8","#b8d8a8",
];

const MEGYE_LIST = Object.keys(HUNGARY_PATHS);

const MEGYE_LABEL_POS = {
  "Győr-Moson-Sopron":{x:115,y:98},"Komárom-Esztergom":{x:242,y:100},
  "Vas":{x:68,y:162},"Veszprém":{x:172,y:158},"Zala":{x:65,y:215},
  "Somogy":{x:158,y:232},"Fejér":{x:272,y:152},"Budapest":{x:330,y:128},
  "Pest":{x:340,y:118},"Tolna":{x:322,y:208},"Baranya":{x:295,y:252},
  "Bács-Kiskun":{x:408,y:210},"Nógrád":{x:392,y:92},"Heves":{x:438,y:108},
  "Jász-Nagykun-Szolnok":{x:448,y:182},"Borsod-Abaúj-Zemplén":{x:495,y:82},
  "Szabolcs-Szatmár-Bereg":{x:588,y:78},"Hajdú-Bihar":{x:562,y:155},
  "Békés":{x:542,y:228},"Csongrád-Csanád":{x:498,y:248},
};
...
function HungarianMap({ profiles, user, onProfileClick }) {
  ...
  const getColor = (megye, idx) => {
    const base = MEGYE_COLORS[idx % MEGYE_COLORS.length];
    if(selectedMegye===megye) return "#c8f230";
    if(hoveredMegye===megye) return "#ffd700";
    return base;
  };

  const getOpacity = (megye) => {
    if(selectedMegye===megye) return 1;
    if(hoveredMegye===megye) return 1;
    return megyCounts[megye]>0 ? 0.9 : 0.45;
  };
  ...
  return (
    <div>
      ...
      <div className="card" style={{padding:"0.5rem",marginBottom:"1rem"}}>
        <svg viewBox="0 0 700 310" style={{width:"100%",height:"auto",display:"block"}}>
          <defs>
            <filter id="shadow">
          ...
          {Object.entries(HUNGARY_PATHS).map(([megye, path], idx)=>{
            const count = megyCounts[megye]||0;
            const isSelected = selectedMegye===megye;
            const isHovered = hoveredMegye===megye;
            const labelPos = MEGYE_LABEL_POS[megye];
            return (
              <g key={megye} style={{cursor:"pointer"}} filter={isSelected||isHovered?"url(#shadow)":undefined}
                onClick={()=>setSelectedMegye(isSelected?null:megye)}
                onMouseEnter={()=>setHoveredMegye(megye)}
                onMouseLeave={()=>setHoveredMegye(null)}>
                <path d={path}
                  fill={getColor(megye,idx)}
                  stroke="#fff"
                  strokeWidth={isSelected?2:1}
                  opacity={getOpacity(megye)}
                  style={{transition:"all 0.2s"}}/>
                {/* Megye neve */}
                {labelPos&&(
                  <text x={labelPos.x} y={labelPos.y}
                    textAnchor="middle" fontSize={megye==="Budapest"?5:megye.length>15?4.2:5}
                    fontWeight={isSelected?"bold":"500"}
                    fill={isSelected?"#0a0a0a":"#1a1a1a"}
                ...
                {count>0&&labelPos&&(
                  <>
                    <circle cx={labelPos.x+18} cy={labelPos.y-8} r="7"
                      fill="#c8f230" opacity="0.95"/>
                    <text x={labelPos.x+18} y={labelPos.y-5}
                      textAnchor="middle" fontSize="5.5" fontWeight="bold" fill="#0a0a0a"
        ...
        {/* Hover info */}
        <div style={{textAlign:"center",height:20,fontSize:"0.78rem",color:"var(--text2)"}}>
          {hoveredMegye&&<span><strong style={{color:"var(--text)"}}>{hoveredMegye}</strong> — {megyCounts[hoveredMegye]||0} edző</span>}
        </div>
      </div>
        ...
        <div>
          ...
          {filteredProfiles.length===0?(
            <div className="card" style={{textAlign:"center",padding:"2.5rem"}}>
              ...
              <div style={{color:"var(--text2)",fontSize:"0.85rem",marginBottom:"1rem"}}>Még nincs regisztrált edző {selectedMegye}ben/ban.</div>
              <button className="btn btn-neon btn-sm" onClick={()=>{}}>👤 Profil kitöltése</button>
            </div>
          ):(
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:"0.75rem"}}>
              {filteredProfiles.map(p=>(
      ...
      {!selectedMegye&&(
        <div style={{textAlign:"center",padding:"1rem",color:"var(--muted)",fontSize:"0.82rem"}}>
          Kattints egy megyére • Zöld szám = regisztrált edzők száma
        </div>
      )}
    </div>
  );
