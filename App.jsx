...
// ── Hungarian Map ─────────────────────────────────────────────────────────────
const MEGYE_PATHS = {
  "Budapest": "M 365,148 L 378,142 L 390,148 L 388,162 L 375,165 L 363,158 Z",
  "Pest": "M 335,110 L 410,108 L 425,135 L 420,175 L 390,185 L 365,178 L 363,158 L 375,165 L 388,162 L 390,148 L 378,142 L 365,148 L 355,140 L 330,145 L 320,130 Z",
  "Fejér": "M 295,155 L 330,145 L 355,140 L 365,148 L 363,158 L 355,175 L 355,200 L 330,215 L 300,210 L 280,190 L 285,168 Z",
  "Komárom-Esztergom": "M 270,105 L 335,110 L 320,130 L 295,145 L 285,135 L 265,120 Z",
  "Győr-Moson-Sopron": "M 175,95 L 270,105 L 265,120 L 245,130 L 225,140 L 195,135 L 170,115 Z",
  "Vas": "M 175,140 L 225,140 L 225,175 L 210,200 L 185,205 L 165,190 L 165,160 Z",
  "Zala": "M 185,205 L 210,200 L 225,175 L 235,185 L 245,215 L 230,235 L 205,235 L 188,220 Z",
  "Somogy": "M 230,235 L 245,215 L 280,210 L 300,210 L 330,215 L 340,240 L 325,260 L 290,268 L 255,262 L 232,248 Z",
  "Tolna": "M 330,215 L 355,200 L 375,205 L 380,230 L 360,255 L 340,260 L 325,260 L 340,240 Z",
  "Baranya": "M 325,260 L 360,255 L 380,265 L 375,285 L 350,295 L 315,285 L 305,270 Z",
  "Bács-Kiskun": "M 380,230 L 420,220 L 450,225 L 460,250 L 455,275 L 420,285 L 390,280 L 375,265 L 380,245 Z",
  "Csongrád-Csanád": "M 455,255 L 490,250 L 510,265 L 510,290 L 490,305 L 455,295 L 445,275 Z",
  "Békés": "M 460,220 L 500,215 L 525,225 L 525,255 L 510,265 L 490,250 L 455,255 L 450,240 Z",
  "Hajdú-Bihar": "M 490,160 L 530,155 L 555,165 L 555,200 L 540,220 L 525,225 L 500,215 L 480,200 L 475,178 Z",
  "Szabolcs-Szatmár-Bereg": "M 490,115 L 545,110 L 575,120 L 580,150 L 555,165 L 530,155 L 490,160 L 480,145 L 475,125 Z",
  "Jász-Nagykun-Szolnok": "M 420,175 L 470,170 L 480,145 L 490,160 L 475,178 L 480,200 L 460,220 L 450,225 L 420,220 L 400,210 L 395,190 Z",
  "Heves": "M 390,125 L 430,120 L 450,130 L 455,150 L 440,165 L 420,175 L 395,190 L 388,175 L 390,148 L 390,148 Z",
  "Nógrád": "M 370,100 L 410,100 L 430,110 L 430,120 L 390,125 L 370,118 Z",
  "Borsod-Abaúj-Zemplén": "M 420,85 L 480,80 L 510,90 L 520,110 L 500,125 L 470,130 L 450,130 L 430,120 L 430,110 L 410,100 L 390,98 Z",
};

const MEGYE_LABELS = {
  "Budapest":{x:376,y:156},"Pest":{x:375,y:138},"Fejér":{x:322,y:182},
  "Komárom-Esztergom":{x:300,y:118},"Győr-Moson-Sopron":{x:218,y:113},
  "Vas":{x:196,y:172},"Zala":{x:210,y:220},"Somogy":{x:283,y:245},
  "Tolna":{x:352,y:232},"Baranya":{x:343,y:275},"Bács-Kiskun":{x:420,y:252},
  "Csongrád-Csanád":{x:478,y:275},"Békés":{x:492,y:237},"Hajdú-Bihar":{x:515,y:185},
  "Szabolcs-Szatmár-Bereg":{x:528,y:135},"Jász-Nagykun-Szolnok":{x:450,y:192},
  "Heves":{x:422,y:148},"Nógrád":{x:398,y:108},"Borsod-Abaúj-Zemplén":{x:465,y:100},
};
...
function HungarianMap({ profiles, user, onProfileClick }) {
  ...
  const getColor = (megye) => {
    const count = megyCounts[megye]||0;
    if(selectedMegye===megye) return "#c8f230";
    if(hoveredMegye===megye) return count>0?"#ff6b35":"#3a3a3a";
    if(count===0) return "#1e2025";
    if(count<3) return "#2a4a1a";
    if(count<6) return "#3d6b1a";
    return "#5a9e00";
  };
  ...
  return (
    <div>
      <div style={{marginBottom:"1rem"}}>
        ...
        <p style={{color:"var(--text2)",fontSize:"0.82rem"}}>Kattints egy megyére a helyi edzők megtekintéséhez</p>
      </div>

      {/* SVG Térkép */}
      <div className="card" style={{padding:"0.75rem",marginBottom:"1rem",overflow:"hidden"}}>
        <svg viewBox="150 75 440 235" style={{width:"100%",height:"auto",display:"block"}}>
          {/* Háttér */}
          <rect x="150" y="75" width="440" height="235" fill="var(--surface2)" rx="8"/>

          {/* Megye path-ok */}
          {Object.entries(MEGYE_PATHS).map(([megye, path])=>{
            const count = megyCounts[megye]||0;
            const isSelected = selectedMegye===megye;
            const isHovered = hoveredMegye===megye;
            return (
              <g key={megye} style={{cursor:"pointer"}}
                onClick={()=>setSelectedMegye(isSelected?null:megye)}
                onMouseEnter={()=>setHoveredMegye(megye)}
                onMouseLeave={()=>setHoveredMegye(null)}>
                <path d={path}
                  fill={getColor(megye)}
                  stroke={isSelected?"#c8f230":isHovered?"rgba(255,255,255,0.4)":"rgba(255,255,255,0.15)"}
                  strokeWidth={isSelected?1.5:0.8}
                  style={{transition:"fill 0.2s, stroke 0.2s"}}/>
                {/* Edzők száma ha van */}
                {count>0&&(
                  <circle cx={MEGYE_LABELS[megye]?.x} cy={MEGYE_LABELS[megye]?.y-8} r="6"
                    fill={isSelected?"#0a0a0a":"#c8f230"} opacity="0.9"/>
                )}
                {count>0&&(
                  <text x={MEGYE_LABELS[megye]?.x} y={MEGYE_LABELS[megye]?.y-5}
                    textAnchor="middle" fontSize="5" fontWeight="bold"
                    fill={isSelected?"#c8f230":"#0a0a0a"}>
                    {count}
                  </text>
                )}
              </g>
          ...
          {/* Megye nevek */}
          {Object.entries(MEGYE_LABELS).map(([megye,pos])=>(
            <text key={megye} x={pos.x} y={pos.y+6}
              textAnchor="middle" fontSize="4.2" fontWeight="500"
              fill={selectedMegye===megye?"#c8f230":"rgba(255,255,255,0.6)"}
              style={{pointerEvents:"none",userSelect:"none"}}>
              {megye==="Szabolcs-Szatmár-Bereg"?"Szabolcs":
               megye==="Jász-Nagykun-Szolnok"?"Jász-N-Sz":
               megye==="Komárom-Esztergom"?"Komárom":
               megye==="Győr-Moson-Sopron"?"Győr-M-S":
               megye==="Borsod-Abaúj-Zemplén"?"Borsod":
               megye==="Csongrád-Csanád"?"Csongrád":
               megye==="Bács-Kiskun"?"Bács-K":megye}
            </text>
          ))}
        </svg>
        ...
        {/* Legenda */}
        <div style={{display:"flex",gap:"1rem",flexWrap:"wrap",marginTop:"0.5rem",justifyContent:"center"}}>
          {[["#2a4a1a","1-2 edző"],["#3d6b1a","3-5 edző"],["#5a9e00","6+ edző"]].map(([c,l])=>(
            <div key={l} style={{display:"flex",alignItems:"center",gap:"0.35rem",fontSize:"0.72rem",color:"var(--text2)"}}>
              <div style={{width:10,height:10,borderRadius:2,background:c}}/>
              {l}
            </div>
          ))}
          <div style={{fontSize:"0.72rem",color:"var(--muted)"}}>⚪ üres megye</div>
        </div>
      </div>

      {/* Tooltip hover */}
      {hoveredMegye&&!selectedMegye&&(
        <div style={{textAlign:"center",marginBottom:"0.75rem",fontSize:"0.85rem",color:"var(--text2)"}}>
          <strong style={{color:"var(--text)"}}>{hoveredMegye}</strong> - {megyCounts[hoveredMegye]||0} regisztrált edző
        </div>
      )}
      ...
      {selectedMegye&&(
        <div>
          <div style={{display:"flex",alignItems:"center",gap:"0.75rem",marginBottom:"1rem",padding:"0.75rem 1rem",background:"var(--neon-dim)",border:"1px solid rgba(200,242,48,0.25)",borderRadius:12}}>
            ...
            <button className="btn btn-ghost btn-sm" onClick={()=>setSelectedMegye(null)}>✕</button>
          </div>
          ...
          {filteredProfiles.length===0?(
            <div className="card" style={{textAlign:"center",padding:"2.5rem",color:"var(--muted)"}}>
              ...
              <div style={{fontSize:"0.85rem",marginBottom:"1rem"}}>Még nincs regisztrált edző {selectedMegye}ben/ban.</div>
            </div>
          ):(
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:"0.75rem"}}>
              {filteredProfiles.map(p=>(
      ...
      {!selectedMegye&&(
        <div style={{textAlign:"center",padding:"1.5rem",color:"var(--muted)",fontSize:"0.85rem"}}>
          👆 Kattints egy zöld megyére az ott edzők megtekintéséhez
        </div>
      )}
    </div>
  );
