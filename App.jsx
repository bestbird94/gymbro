      ...
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",background:"#000"}}>
        <div style={{position:"relative",width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center"}}>
          <img src={story.media_url} alt="story"
            style={{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",borderRadius:0}}
            draggable="false"/>
        </div>
      </div>
      {/* Caption */}
      ...
      <div className="app">
        <nav className="nav">
          ...
          <div className="nav-tabs">
            {[["kereses","🔍 Keresés"],["ai","🤖 AI"],["profil","👤 Profil"]].map(([k,l])=>(
            ...
            <>
              ...
              <div className="filter-bar">
                ...
                <div style={{position:"relative",marginBottom:"0.75rem"}}>
                  ...
                  <input className="form-input" placeholder="Keresés névr e..." value={fNev}
                    onChange={e=>setFNev(e.target.value)}
                    style={{paddingLeft:"2.2rem",fontSize:"0.88rem"}}/>
                  {fNev&&<button onClick={()=>setFNev("")} style={{position:"absolute",right:"0.75rem",top:"50%",transform:"translateY(-50%)",background:"none",border:"none",color:"var(--muted)",cursor:"pointer",fontSize:"1rem"}}>✕</button>}
                </div>
