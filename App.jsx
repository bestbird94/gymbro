...
const STYLES = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pulse { display: inline-block; width: 7px; height: 7px; background: var(--neon); border-radius: 50%; }
  ...
  .live-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--orange); flex-shrink: 0; box-shadow: 0 0 8px rgba(255,107,53,0.6); }
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",paddingTop:"0.5rem"}}>
      ...
      <div style={{display:"flex",gap:"1rem",marginBottom:"1rem",width:"100%",maxWidth:380}}>
        {streak>0&&(
          <div style={{flex:1,background:"rgba(255,107,53,0.1)",border:"1px solid rgba(255,107,53,0.3)",borderRadius:10,padding:"0.5rem 0.75rem",textAlign:"center"}}>
...
// ── Hungarian Map ─────────────────────────────────────────────────────────────
// Valódi SVG path-ok Magyarország megyéihez - viewBox 0 0 1000 560
const HU_PATHS = {
  "Győr-Moson-Sopron": "M 30,110 L 55,85 L 85,75 L 130,72 L 175,78 L 215,88 L 248,102 L 255,118 L 240,132 L 215,140 L 185,145 L 155,148 L 120,145 L 88,138 L 58,128 Z",
  "Vas": "M 30,110 L 58,128 L 88,138 L 95,158 L 88,182 L 72,205 L 52,218 L 30,215 L 15,195 L 12,162 L 18,132 Z",
  "Zala": "M 52,218 L 72,205 L 88,182 L 102,190 L 118,210 L 112,238 L 95,260 L 72,268 L 48,258 L 35,238 L 38,220 Z",
  "Somogy": "M 95,260 L 112,238 L 118,210 L 148,200 L 178,195 L 208,198 L 232,212 L 248,238 L 242,265 L 218,278 L 185,282 L 152,278 L 118,268 Z",
  "Veszprém": "M 155,148 L 185,145 L 215,140 L 240,132 L 255,118 L 278,118 L 298,128 L 308,148 L 302,168 L 282,182 L 255,188 L 228,185 L 205,175 L 178,168 L 158,158 Z",
  "Fejér": "M 255,118 L 298,112 L 328,118 L 348,132 L 352,155 L 342,178 L 318,192 L 295,195 L 268,188 L 255,175 L 255,155 Z",
  "Komárom-Esztergom": "M 248,102 L 285,95 L 318,98 L 342,108 L 355,122 L 348,132 L 328,118 L 298,112 L 255,118 L 240,108 Z",
  "Budapest": "M 348,132 L 368,125 L 382,132 L 385,148 L 372,158 L 355,155 L 348,145 Z",
  "Pest": "M 318,98 L 355,90 L 398,88 L 432,95 L 452,112 L 458,135 L 445,158 L 422,172 L 395,178 L 368,172 L 348,158 L 355,155 L 372,158 L 385,148 L 382,132 L 368,125 L 348,132 L 342,118 L 342,108 L 318,98 Z",
  "Nógrád": "M 398,88 L 432,82 L 462,85 L 482,98 L 478,115 L 458,128 L 432,132 L 408,128 L 395,115 L 398,98 Z",
  "Heves": "M 432,95 L 462,88 L 498,92 L 522,105 L 525,125 L 508,142 L 485,148 L 458,142 L 445,128 L 452,112 Z",
  "Borsod-Abaúj-Zemplén": "M 462,65 L 515,55 L 568,58 L 612,68 L 635,85 L 628,108 L 605,122 L 572,128 L 538,125 L 508,118 L 488,105 L 478,88 L 462,82 L 455,72 Z",
  "Jász-Nagykun-Szolnok": "M 452,158 L 488,152 L 522,155 L 548,168 L 558,192 L 548,218 L 525,232 L 498,238 L 472,232 L 452,215 L 445,192 L 448,172 Z",
  "Szabolcs-Szatmár-Bereg": "M 572,55 L 628,48 L 678,52 L 708,65 L 712,92 L 692,112 L 658,122 L 625,118 L 598,105 L 578,88 L 572,68 Z",
  "Hajdú-Bihar": "M 572,128 L 605,122 L 638,125 L 665,138 L 672,162 L 658,188 L 635,205 L 605,212 L 575,205 L 552,188 L 548,165 L 555,145 Z",
  "Tolna": "M 318,192 L 342,178 L 368,172 L 395,178 L 408,198 L 402,225 L 382,242 L 355,248 L 325,242 L 308,222 L 308,205 Z",
  "Baranya": "M 308,222 L 325,242 L 355,248 L 378,258 L 375,282 L 352,298 L 318,302 L 285,295 L 262,278 L 258,258 L 268,238 L 288,225 Z",
  "Bács-Kiskun": "M 395,178 L 435,172 L 468,178 L 492,195 L 498,222 L 488,252 L 462,268 L 432,272 L 402,265 L 382,248 L 382,228 L 395,208 L 405,192 Z",
  "Békés": "M 548,192 L 572,185 L 605,188 L 635,198 L 648,222 L 642,248 L 618,265 L 588,272 L 558,265 L 535,248 L 528,225 L 535,205 Z",
  "Csongrád-Csanád": "M 488,225 L 518,218 L 548,225 L 572,238 L 578,262 L 562,282 L 535,292 L 505,288 L 478,272 L 468,252 L 472,232 L 488,222 Z",
};

const HU_LABEL_POS = {
  "Győr-Moson-Sopron":{x:148,y:112},"Vas":{x:55,y:168},"Zala":{x:72,y:235},
  "Somogy":{x:172,y:242},"Veszprém":{x:222,y:162},"Fejér":{x:302,y:158},
  "Komárom-Esztergom":{x:295,y:112},"Budapest":{x:368,y:142},"Pest":{x:390,y:132},
  "Nógrád":{x:438,y:105},"Heves":{x:482,y:122},"Borsod-Abaúj-Zemplén":{x:548,y:92},
  "Jász-Nagykun-Szolnok":{x:498,y:198},"Szabolcs-Szatmár-Bereg":{x:640,y:82},
  "Hajdú-Bihar":{x:615,y:168},"Tolna":{x:358,y:218},"Baranya":{x:318,y:265},
  "Bács-Kiskun":{x:435,y:228},"Békés":{x:592,y:228},"Csongrád-Csanád":{x:525,y:258},
};

const HU_COLORS = {
  "Győr-Moson-Sopron":"#a8d4a8","Vas":"#d4b8a8","Veszprém":"#b8d4e8",
  "Zala":"#d4c8a8","Somogy":"#c8d4a8","Fejér":"#a8c8d4","Budapest":"#e8a8a8",
  "Pest":"#d4e8c8","Komárom-Esztergom":"#c8b8d4","Nógrád":"#e8d4a8",
  "Heves":"#b8e8c8","Borsod-Abaúj-Zemplén":"#e8c8a8","Jász-Nagykun-Szolnok":"#c8e8d4",
  "Szabolcs-Szatmár-Bereg":"#d4a8e8","Hajdú-Bihar":"#e8d4b8","Tolna":"#b8d4c8",
  "Baranya":"#d4b8e8","Bács-Kiskun":"#e8e4a8","Békés":"#a8d4c8","Csongrád-Csanád":"#d4e8a8",
};

function HungarianMap({ profiles, user, onProfileClick }) {
  const [selectedMegye, setSelectedMegye] = useState(null);
  const [hoveredMegye, setHoveredMegye] = useState(null);
  ...
  const filteredProfiles = selectedMegye ? profiles.filter(p=>p.megye===selectedMegye) : [];

  return (
    <div>
      <div style={{marginBottom:"1rem"}}>
        <h2 style={{fontFamily:"var(--font-display)",fontSize:"1.6rem",letterSpacing:2,marginBottom:"0.25rem"}}>🗺️ MAGYARORSZÁG</h2>
        <p style={{color:"var(--text2)",fontSize:"0.82rem"}}>Kattints egy megyére az ott edzők megtekintéséhez</p>
      </div>

      <div className="card" style={{padding:"0.5rem",marginBottom:"1rem"}}>
        <svg viewBox="0 0 750 360" style={{width:"100%",height:"auto",display:"block"}}>
          <defs>
            <filter id="mapshadow">
          ...
          {Object.entries(HU_PATHS).map(([megye, path])=>{
            const count = megyCounts[megye]||0;
            const isSelected = selectedMegye===megye;
            const isHovered = hoveredMegye===megye;
            const labelPos = HU_LABEL_POS[megye];
            const baseColor = HU_COLORS[megye]||"#c8d4b8";

            // Color logic
            let fillColor = baseColor;
            let fillOpacity = count>0 ? 1 : 0.5;
            if(isSelected){ fillColor="#c8f230"; fillOpacity=1; }
            else if(isHovered){ fillColor="#ffd700"; fillOpacity=1; }
            else if(count>0){
              // Darker shade when has users
              fillColor = baseColor;
            }
            ...
            return (
              <g key={megye}
                ...
                onClick={()=>setSelectedMegye(isSelected?null:megye)}
                onMouseEnter={()=>setHoveredMegye(megye)}
                onMouseLeave={()=>setHoveredMegye(null)}>
                <path d={path}
                  fill={fillColor}
                  stroke="#ffffff"
                  ...
                  style={{transition:"fill 0.18s, fill-opacity 0.18s"}}/>

                {/* Megye neve */}
                {labelPos&&(
                  <text x={labelPos.x} y={labelPos.y}
                    textAnchor="middle"
                    fontSize={megye==="Budapest"?5.5:megye.length>18?3.8:megye.length>12?4.2:5}
                    fontWeight={isSelected||isHovered?"bold":"600"}
                    fill={isSelected?"#1a1a1a":isHovered?"#1a1a1a":"#2a2a2a"}
                    style={{pointerEvents:"none",userSelect:"none"}}>
                    {megye==="Szabolcs-Szatmár-Bereg"?"Szabolcs-Sz-B":
                     megye==="Jász-Nagykun-Szolnok"?"Jász-N-Sz":
                     megye==="Komárom-Esztergom"?"Komárom-E":
                     megye==="Győr-Moson-Sopron"?"Győr-M-S":
                     megye==="Borsod-Abaúj-Zemplén"?"Borsod-A-Z":
                     megye==="Csongrád-Csanád"?"Csongrád-Cs":megye}
                  </text>
                )}

                {/* Edző számláló buborék */}
                {count>0&&labelPos&&(
                  <>
                    <circle cx={labelPos.x} cy={labelPos.y+9} r="7.5"
                      fill={isSelected?"#0a0a0a":"#1a5200"} opacity="0.85"/>
                    <text x={labelPos.x} y={labelPos.y+12.5}
                      textAnchor="middle" fontSize="6" fontWeight="bold"
                      fill="#c8f230"
        ...
        {/* Hover tooltip */}
        <div style={{textAlign:"center",minHeight:22,fontSize:"0.8rem",color:"var(--text2)",marginTop:"0.25rem"}}>
          {hoveredMegye
            ? <span><strong style={{color:"var(--text)"}}>{hoveredMegye}</strong> — {megyCounts[hoveredMegye]||0} regisztrált edző</span>
            : <span style={{color:"var(--muted)"}}>Kattints egy megyére</span>
          }
        </div>
      </div>
      ...
      {selectedMegye&&(
        <div>
          <div style={{display:"flex",alignItems:"center",gap:"0.75rem",marginBottom:"1rem",padding:"0.75rem 1rem",background:"var(--neon-dim)",border:"1px solid rgba(200,242,48,0.25)",borderRadius:12}}>
            <span style={{fontSize:"1.2rem"}}>📍</span>
            <div style={{flex:1}}>
              <div style={{fontFamily:"var(--font-display)",fontSize:"1.3rem",letterSpacing:1,color:"var(--neon)"}}>{selectedMegye}</div>
              <div style={{fontSize:"0.78rem",color:"var(--text2)"}}>{filteredProfiles.length} regisztrált edző</div>
            </div>
            <button className="btn btn-ghost btn-sm" onClick={()=>setSelectedMegye(null)}>✕ Vissza</button>
          </div>
          {filteredProfiles.length===0?(
            <div className="card" style={{textAlign:"center",padding:"2.5rem"}}>
              <div style={{fontSize:"2rem",marginBottom:"0.5rem"}}>🏋️</div>
              <div style={{fontFamily:"var(--font-display)",fontSize:"1.2rem",color:"var(--neon)",marginBottom:"0.5rem"}}>LEGYÉL AZ ELSŐ!</div>
              <div style={{color:"var(--text2)",fontSize:"0.85rem"}}>Még nincs regisztrált edző {selectedMegye}ben/ban.</div>
            </div>
          ):(
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:"0.75rem"}}>
              {filteredProfiles.map(p=>(
      ...
      {!selectedMegye&&(
        <div style={{textAlign:"center",padding:"0.75rem",color:"var(--muted)",fontSize:"0.8rem"}}>
          Zöld buborék = ott edzők száma
        </div>
      )}
    </div>
  );
  ...
  return (
    <div style={{marginBottom:"1.25rem"}}>
      <div style={{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.6rem"}}>
        <span style={{width:8,height:8,borderRadius:"50%",background:"#ff6b35",display:"inline-block",boxShadow:"0 0 6px rgba(255,107,53,0.6)"}}/>
...
export default function GymBro() {
  ...
  const [viewMode, setViewMode] = useState("lista"); // lista | swipe | terkep
  ...
  useEffect(()=>{
    ...
    if(!alreadySeen && now.getDate()<=3){
      const t = setTimeout(()=>setShowMonthlyWrapup(true), 2000);
  ...
  useEffect(()=>{
    if(!myProfile.megye||!maEdzek||!maEdzekIdo) { setWorkoutBuddies([]); return; }
  ...
  },[maEdzek, maEdzekIdo, myProfile.megye, myProfile.varos]);
  ...
  async function addXp(amount, challengeKey=null){
    ...
    setXpAnim(`+${amount} XP`);
    const _t=setTimeout(()=>setXpAnim(null),2000);
  ...
  // Napi belépés XP - csak egyszer fut
  useEffect(()=>{
    if(!myProfileId||!user) return;
    const today=new Date().toDateString();
    const key="gymbro_last_xp_"+user.id;
    if(localStorage.getItem(key)!==today){
      localStorage.setItem(key,today);
      setTimeout(()=>addXp(1),1000);
    }
  },[myProfileId]);
          ...
          {tab==="kereses"&&(
            <>
              ...
              {workoutBuddies.length>0&&tab==="kereses"&&(
                <div style={{background:"linear-gradient(135deg,rgba(255,107,53,0.12),rgba(255,107,53,0.06))",border:"1px solid rgba(255,107,53,0.35)",borderRadius:12,padding:"0.85rem 1.1rem",marginBottom:"1rem"}}>
              ...
              {/* Nézet váltó - 3 mód */}
              <div style={{display:"flex",background:"var(--surface)",border:"1px solid var(--border2)",borderRadius:12,padding:"0.3rem",marginBottom:"1.25rem",gap:"0.25rem"}}>
                {[
                  {key:"lista",icon:"🔍",label:"Lista"},
                  {key:"terkep",icon:"🗺️",label:"Térkép"},
                  {key:"swipe",icon:"🔥",label:"Swipe"},
                ].map(({key,icon,label})=>(
                  <button key={key} onClick={()=>setViewMode(key)} style={{flex:1,padding:"0.5rem 0.25rem",borderRadius:9,border:"none",cursor:"pointer",fontFamily:"var(--font-body)",fontWeight:600,fontSize:"0.82rem",transition:"all 0.2s",
                    background:viewMode===key?(key==="swipe"?"#ff4444":key==="terkep"?"var(--purple)":"var(--neon)"):"transparent",
                    color:viewMode===key?(key==="lista"?"#0a0a0a":"#fff"):"var(--muted)"}}>
                    {icon} {label}
                  </button>
                ))}
              </div>
              ...
              {viewMode==="terkep"&&(
                <HungarianMap profiles={profiles.filter(p=>!myBlocks.includes(p.id))} user={user} onProfileClick={setSelected}/>
              )}
